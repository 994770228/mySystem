<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\phpStudy\WWW\my\public/../application/admin\view\my_employee\add.html";i:1502852240;s:70:"D:\phpStudy\WWW\my\public/../application/admin\view\template\base.html";i:1500952537;s:81:"D:\phpStudy\WWW\my\public/../application/admin\view\template\javascript_vars.html";i:1488899632;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="姓名" name="field1" value="<?php echo isset($vo['field1']) ? $vo['field1'] :  ''; ?>"  datatype="*" nullmsg="请填写姓名">
            </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="账号" name="field1" value="<?php echo isset($vo['field1']) ? $vo['field1'] :  ''; ?>"  datatype="*" nullmsg="请填写账号">
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="密码" name="field1" value="<?php echo isset($vo['field1']) ? $vo['field1'] :  ''; ?>"  datatype="*" nullmsg="请填写密码">
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        <div class="row cl">
